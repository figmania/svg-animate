...
export const Tutorial: FunctionComponent<TutorialProps> = ({ show, messenger }) => {
  if (!show) { return <Button className="tutorial-button" title="Show Tutorial" onClick={() => { messenger.request<boolean, boolean>('tutorial', true) }}></Button> }
  return <div className="tutorial">
    ...
    <Button className="tutorial-button" title="Hide Tutorial" onClick={() => { messenger.request<boolean, boolean>('tutorial', false) }}></Button>
  </div>
}
